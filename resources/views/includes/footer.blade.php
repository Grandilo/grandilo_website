<footer id="fh5co-footer" role="contentinfo">
    ...
    <div class="container">
        ...
        <div class="col-md-3 col-md-push-1 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
            <h3>Contact</h3>
            <ul class="float">
                <li>Email: info@grandilo.com</li>
                <li>Phone: +2347039056183</li>
                <li>Address:  No 32, Barikisu Iyede Street, off Unilag road, Yaba, Lagos, Nigeria
                </li>
            </ul>
        ...
        <div class="col-md-2 col-md-push-1 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
            ...
            <ul class="fh5co-social">
                ...
                <li><a href="https://www.facebook.com/grandilo"><i class="icon-facebook"></i></a></li>
        ...
        <div class="col-md-12 fh5co-copyright text-center">
            <p>&copy; 2016 Grandilo Technology. </p>

            <p>Grandilo Tehnology is Registered with the Corperate Affairs Commission with Reg number: BN2424789</p>
        </div>
...
<script type="text/javascript">
    ...
    (function(){
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/57adc1ef1aad34d80cf3f60b/default';
        s1.charset='UTF-8';
