                ...
                <div class="col-md-12">
                    ...
                    <!-- <h2 style="color: #009688; margin-top: 10px "   class="head-main-text">
                        <div style="line-height: 200%">
                            ...
                            <p>
                                Grandilo developer interns are paid to learn and build world class web/mobile applications in collaboration with our senior developers. This internship runs for a period of 6 months.<br>
                                Our internship can be competitive sometimes so only the top 10% are selected
